...
from yolov9_main.models.yolo import SegmentationModel
from yolov9_main.utils.callbacks import Callbacks
from yolov9_main.utils.coco_utils import getCocoIds, getMappingId, getMappingIndex
from yolov9_main.utils.general import (LOGGER, NUM_THREADS, TQDM_BAR_FORMAT, Profile, check_dataset, check_img_size,
...
from yolov9_main.utils.metrics import ConfusionMatrix, box_iou
from yolov9_main.utils.plots import output_to_target, plot_val_study
from yolov9_main.utils.panoptic.dataloaders import create_dataloader
from yolov9_main.utils.panoptic.general import mask_iou, process_mask, process_mask_upsample, scale_image
from yolov9_main.utils.panoptic.metrics import Metrics, ap_per_class_box_and_mask, Semantic_Metrics
from yolov9_main.utils.panoptic.plots import plot_images_and_masks
from yolov9_main.utils.torch_utils import de_parallel, select_device, smart_inference_mode
...
def run(
    ...
    if save_json and len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            # Semantic Segmentation
            from yolov9_main.utils.stuff_seg.cocostuffeval import COCOStuffeval
