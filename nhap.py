...
#------------------------------------------------------CHECK REALFOG DATASET--------------------------------------------------------
# what should i do now 

foggypath = r"D:\Downloads\lab\FIOD_\dataset01\Foggy_Driving\Processed_foggy_driving"
foggy_dataset = RealFogDataset(foggypath)
dataloader = DataLoader(foggy_dataset, batch_size=4, shuffle=True, collate_fn=foggy_dataset.collate_fn)
for i, batch in enumerate(dataloader):
    foggy_img = batch[0][0]
    # foggy_img = foggy_img.cpu().detach().numpy()
    img_name = batch[1][0]
